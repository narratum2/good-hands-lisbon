...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://beautysalonlisbon.com/alfama',
  },
}
    ...
    <div className="pt-20">
      ...
      <section className="relative h-[70vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image src="/brand-images/neighborhood-guide-alfama-hero.png" alt="Historic Alfama neighborhood Lisbon - authentic beauty experiences in traditional setting" fill className="object-cover" priority />
