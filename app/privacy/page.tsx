      ...
      <div className="container-custom max-w-4xl py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-harbor leading-relaxed mt-3">
              To exercise these rights, contact us at privacy@beautysalonlisbon.com
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-shell p-6 rounded-lg">
              <p className="text-harbor"><strong>Email:</strong> privacy@beautysalonlisbon.com</p>
              <p className="text-harbor"><strong>Data Protection Officer:</strong> dpo@beautysalonlisbon.com</p>
